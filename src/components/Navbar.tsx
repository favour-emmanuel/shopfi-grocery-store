...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-appGreen sticky text-white py-5 lg:px-8 px-5 flex justify-between items-center">
        {/* drawer */}
        <div className="flex items-center gap-3 cursor-pointer">
          {/* sideMenuIcon */}
          <div
            className="bg-[#7C9E77] py-2.5 px-3 rounded-md"
      ...
      <MobileNavBar isOpen={sideMenu} closeMobileMenu={handleCloseMobileMenu} />
    </>
  );
};
